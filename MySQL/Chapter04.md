...
![image-20230106212612809](./images/image-20230106212612809.png)
...
![image-20230106212732346](./images/image-20230106212732346.png)

![image-20230106212752255](./images/image-20230106212752255.png)
...
==可以看到，使用**安全等于**运算符时，两边的操作数的值都为NULL时，返回的结果为1而不是NULL，其他返回结果与等于运算符相同。==
...
![image-20230106213206590](./images/image-20230106213206590.png)

![image-20230106213239868](./images/image-20230106213239868.png)
...
![image-20230106214105253](./images/image-20230106214105253.png)
...
![image-20230106214127109](./images/image-20230106214127109.png)

## 5. 运算符的优先级

数字编号越大，优先级越高，优先级高的运算符先进行计算。

![image-20230106214141006](./images/image-20230106214141006.png)

![image-20230106214150031](./images/image-20230106214150031.png)

## 扩展：使用正则表达式查询

![image-20230106214212235](./images/image-20230106214212235.png)
